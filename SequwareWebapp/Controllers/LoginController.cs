        ...
        public ActionResult SignIn(string username, string password)
        {
            try
            {
                    ...
                    user.Password == password)
                {
                    ...
                    {
                        ViewBag.LoginMessage = "License Expiriy not set, Please contact Sequware ownership!";
                        return View("Login");
                    }

                    ViewBag.LoginMessage = "Warning! Activate Company data from Owner.";
                    return View("Login");
                }
                else
                {
                    ViewBag.LoginMessage = "Warning! Username or password is wrong.";
                    return View("Login");
                }
            ...
            {
                ViewBag.LoginMessage = "Warning! Enter correct Username format!";
                return View("Login");
            }
